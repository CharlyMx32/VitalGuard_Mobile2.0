                  ...
                  RichText(
                    ...
                    text: TextSpan(
                      ...
                      children: [
                        ...
                        const TextSpan(
                          text:
                              ' detallados que tu médico puede revisar para ajustar tu tratamiento.',
                        ),
                      ],
                    ),
                  ),
            ...
            children: [
              ...
              Expanded(
                child: Row(
                  ...
                  children: [
                    _buildBar(0.85, const Color(0xFF27AE60)),
                    const SizedBox(width: 6),
                    _buildBar(0.90, const Color(0xFF27AE60)),
                    const SizedBox(width: 6),
                    _buildBar(0.70, const Color(0xFF6FCF97)),
                    const SizedBox(width: 6),
                    _buildBar(0.80, const Color(0xFF27AE60)),
                    const SizedBox(width: 6),
                    _buildBar(0.60, const Color(0xFFF2C94C)),
                    const SizedBox(width: 6),
                    _buildBar(0.85, const Color(0xFF27AE60)),
                    const SizedBox(width: 6),
                    _buildBar(0.75, const Color(0xFF6FCF97)),
                  ],
                ),
              ),
          ...
          child: Row(
            ...
            children: [
              ...
              SizedBox(
                ...
                height: 36,
                child: CustomPaint(
                  painter: _CircularProgressPainter(0.78),
                  child: Center(
                    child: Text(
                      '78%',
                      style: GoogleFonts.inter(
