...
class MyVitalGuardScreen extends StatelessWidget {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Expanded(
            child: Text('Mi VitalGuard', textAlign: TextAlign.center, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: AppColors.textDark)),
          ),
  ...
  Widget _buildDeviceVisual() {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(colors: [AppColors.accentLight, AppColors.bg]),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              const Text('Conectado', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500, color: AppColors.accent)),
            ],
          ),
          const SizedBox(height: 4),
          const Text('VitalGuard Smart Dispenser', style: TextStyle(fontSize: 13, color: AppColors.textMuted)),
        ],
      ),
    );
  }
  ...
  Widget _buildInfoGroup() {
    final items = [
      ('Estado', 'En línea', AppColors.accent),
      ('Firmware', 'v2.1.3', null),
      ('Número de serie', 'VG-2024-084756', null),
      ('Última sincronización', 'Hace 5 min', null),
    ];
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
            ...
            child: Row(
              children: [
                ...
                Text(item.$2, style: TextStyle(
                  fontSize: 12,
                  color: item.$3 ?? AppColors.textMuted,
                  fontWeight: item.$3 != null ? FontWeight.w600 : FontWeight.w400,
                )),
              ],
            ),
          );
  ...
  Widget _buildButton(String label, Color bg, Color fg, {bool border = false}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: border ? Border.all(color: AppColors.borderLight) : null,
      ),
